    ...
    def test_operational_surfaces_emit_redacted_trace_and_metrics(self) -> None:
        ...
        with self.assertLogs("halligalli.telemetry", level="INFO") as captured, TestClient(create_app(authority)) as client:
            created = client.post(
                ...
                json={"name": "Host", "credentialVerifier": verified_credential(credential), "tableSeatCount": 4, "targetHumanParticipantCount": 2, "difficulty": "normal", "durationSec": 60},
            )
        ...
        self.assertNotIn(verified_credential(credential), lines)
